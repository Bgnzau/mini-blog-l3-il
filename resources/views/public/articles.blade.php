    ...
    <div class="main-layout">
        <div class="articles-col">
            <div class="articles-list">
                ...
                <a href="{{ route('articles.show', 'excepturi-eligendi-aliquid-iste-laboriosam') }}" class="article-item">
                    <div>
        ...
        <aside class="sidebar-col">
            ...
            <div class="sidebar-block">
                ...
                <a href="{{ route('articles.show', 'excepturi-eligendi-aliquid-iste-laboriosam') }}" class="popular-item">
