...
<main style="max-width: 1200px; margin: 40px auto; padding: 0 20px; font-family: 'Segoe UI', sans-serif;">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
        <div style="background: white; padding: 25px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
            ...
            {{-- Correction ici : passage du paramètre 'slug' à la place de 'id' --}}
            <h3 style="margin: 10px 0;"><a href="{{ route('article', ['slug' => 'excepturi-eligendi-aliquid']) }}" style="color: #1a1a2e; text-decoration: none; font-family: Georgia, serif;">Excepturi eligendi aliquid iste laboriosam</a></h3>
        ...
        <div style="background: white; padding: 25px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
            ...
            <h3 style="margin: 10px 0;"><a href="{{ route('article', ['slug' => 'aut-repellat-ut-qui']) }}" style="color: #1a1a2e; text-decoration: none; font-family: Georgia, serif;">Aut repellat ut qui et</a></h3>
        ...
        <div style="background: white; padding: 25px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
            ...
            <h3 style="margin: 10px 0;"><a href="{{ route('article', ['slug' => 'dignissimos-et-eaque']) }}" style="color: #1a1a2e; text-decoration: none; font-family: Georgia, serif;">Dignissimos et eaque aut sed fugiat et</a></h3>
