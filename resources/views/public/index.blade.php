{{--
    EXERCICE — Questions 1 & 7 : Vue enfant — Page d'accueil (route home)
    @extends('app') : hérite du layout public (Question 1)
    @section : injecte le titre et le contenu dans les @yield du layout
    Liens internes : route('articles.index'), route('categories.index'), route('articles.show', $slug)…
--}}
@extends('app')
...
<section class="hero">
    ...
    <section class="section">
        ...
        <div class="articles-grid">
            <a href="{{ route('articles.show', 'excepturi-eligendi-aliquid-iste-laboriosam') }}" class="article-card featured">
            ...
            <a href="{{ route('articles.show', 'excepturi-eligendi-aliquid-iste-laboriosam') }}" class="article-card">
