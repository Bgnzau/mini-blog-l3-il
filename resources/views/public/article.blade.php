{{--
    EXERCICE — Questions 1 & 7 : Détail d'un article (route articles.show)
    Paramètre URL {slug} disponible en vue via $slug (passé par MainController::article).
    Breadcrumb : liens route('home'), route('articles.index'), route('categories.index').
--}}
@extends('app')
...
<div class="article-hero">
        <div class="breadcrumb">
            <a href="{{ route('home') }}">Accueil</a><span>/</span><a href="{{ route('articles.index') }}">Articles</a>
            <span>/</span>
    ...
    <div class="article-layout">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-block">
                ...
                <a href="{{ route('articles.show', 'excepturi-eligendi-aliquid-iste-laboriosam') }}" class="related-card">
