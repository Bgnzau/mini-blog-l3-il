{{--
    EXERCICE — Question 3 : Composant sidebar du dashboard
    Placé dans components/dashboard/ pour le séparer des composants publics (Question 3).
    Question 7 : liens nommés + classe "active" selon la route courante (request()->routeIs).
--}}
<aside class="sidebar">
