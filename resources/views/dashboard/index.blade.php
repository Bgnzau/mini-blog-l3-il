{{--
    EXERCICE — Questions 1, 5, 6 & 7 : Accueil dashboard (route dashboard.index)
    @extends('dashboard') : layout admin uniquement — ne pas utiliser @extends('app').
    @section('page_title') : titre affiché dans la topbar (composant Question 3).
--}}
@extends('dashboard')
